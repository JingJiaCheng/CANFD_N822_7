...
en_result_t Can_Init( CAN_HWINST const hwinst)
{
    ...
    unCCCR.stcField.u1BRSE = 1u; /* Bit rate switching for transmissions enabled. */
    unCCCR.stcField.u1FDOE = 1u; /* FD operation enabled. */
...
*/
    ...
    unNBTP.stcField.u9NBRP   = CAN0_NBRP/*4 - 1*//*pstcConfig->stcBitrate.u16Prescaler*/;
    unNBTP.stcField.u8NTSEG1 = CAN0_NTSEG1/*12-1*//*pstcConfig->stcBitrate.u8TimeSegment1*/;
    unNBTP.stcField.u7NTSEG2 = CAN0_NTSEG2/*3-1*//*pstcConfig->stcBitrate.u8TimeSegment2*/;
    unNBTP.stcField.u7NSJW   = CAN0_NTSJW/*2-1*//*pstcConfig->stcBitrate.u8SyncJumpWidth*/;
    pstcCanFD->unNBTP.u32Register  = unNBTP.u32Register;

    /* Data Bit Timing & Prescaler Register */
    unDBTP.stcField.u5DBRP   = CAN0_DBRP/*1 -1*//*pstcConfig->stcBitrate.u16Prescaler*/;
    unDBTP.stcField.u5DTSEG1 = CAN0_DTSEG1/*12-1*//*pstcConfig->stcBitrate.u8TimeSegment1*/;
    unDBTP.stcField.u4DTSEG2 = CAN0_DTSEG2/*3-1*//*pstcConfig->stcBitrate.u8TimeSegment2*/;
    unDBTP.stcField.u4DSJW   = CAN0_DTSJW/*2-1*//*pstcConfig->stcBitrate.u8SyncJumpWidth*/;
                                          ...
                                          )
{
    ...
    {    
		...
		/* Transmit data frame.*/
	    pstcCanFDTxBuffer->T0_f.RTR = 0u; /* Remote Transmission Request */
	    pstcCanFDTxBuffer->T0_f.XTD = (pstcMsg->stcIdentifier.bExtended == TRUE) ? 1u : 0u; /*1:Extended Identifier */
	    ...
	    pstcCanFDTxBuffer->T1_f.EFC = 0u; /* Event FIFO Control,0:Not store Tx event FIFO */
	    pstcCanFDTxBuffer->T1_f.MM  = 0u; /* Message Marker,Not used */
	    pstcCanFDTxBuffer->T1_f.DLC = pstcMsg->stcData.u8DataLengthCode;
		pstcCanFDTxBuffer->T1_f.FDF = 1; /*0:Frame transmitted in Classic CAN format, 1:Frame transmitted in CAN FD format */
		pstcCanFDTxBuffer->T1_f.BRS = 1; /*1:CAN FD frames transmitted with bit rate switching */
